...
import { TransferController } from '../modules/statements/useCases/transferOperation/TransferController';
...
statementRouter.get('/transfers/:user_id', transferController.handle);
